...
void main()
{
	...
	// floor
	objects[0].geo = quad;
	//changes floor size and pos(translation) "xyz"
	...
	objects[2].gloss = 4;
	//changes earth scale and pos(translation) "xyz"
	...
	while (context.step())
	{
		...
		// this shows the diffrent texture maps / pos in 3D space
		// by changing the targets number 0-3
